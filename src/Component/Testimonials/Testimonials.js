...
function Testimonials(){
    return(
        ...
        <Col className=" What">
         ...
         <div className="rating-image"><img src={require('./Assets/rating.jpg')}></img></div>
        ...
        <div className="d-flex justify-content-start d-flex align-items-center jane"> <img src={require('./Assets/jane.jpg')}></img> <h6> Jane Oliver</h6> </div><br></br>
        <hr></hr>
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua ut ad minim veniam, quis nostrud exercitation.</p>
        <div className="d-flex justify-content-start d-flex align-items-center jane"> <img src={require('./Assets/james.jpg')}></img> <h6> James Winston</h6> </div><br></br>
        <hr></hr>
        </Col>
      </Row>
